...
port2 = 4141
punctuation_sock = TCPSocket.open hostname, port2
port3 = 4242
numbsock = TCPSocket.open hostname, port3
# Ruby shouldn't listen to this line
#
...
speed = 1 / onetoten
#
numberarray = [50, 53, 56, 59, 62, 65, 68, 71, 73, 76]
#
loop {
 str = gets.gsub "\n", ""
 str.size.times {|i|
